...
S0(:,:,1) = single(stdimage('baboon.gray')) / 255;
S0(:,:,2) = single(stdimage('barbara.gray')) / 255;
S0(:,:,3) = single(stdimage('girl.gray')) / 255;
S0(:,:,4) = single(stdimage('lenna.gray')) / 255;
S0(:,:,5) = single(stdimage('pepper.gray')) / 255;
...
% [D, optinf] = s(D0, Sh, lambda, olcdl_surfnc_spropt);
